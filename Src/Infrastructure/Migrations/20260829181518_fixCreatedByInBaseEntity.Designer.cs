...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260829181518_fixCreatedByInBaseEntity")]
    partial class fixCreatedByInBaseEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AppAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.AppController", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.AppRolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.AppAction", b =>
                {
                    b.HasOne("Domain.Entities.AppController", "Controller")
                        .WithMany("Actions")
            ...
            modelBuilder.Entity("Domain.Entities.AppPermission", b =>
                {
                    b.HasOne("Domain.Entities.AppAction", "Action")
                        .WithOne("Permission")
                        .HasForeignKey("Domain.Entities.AppPermission", "ActionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.AppRolePermission", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.AppPermission", "Permission")
