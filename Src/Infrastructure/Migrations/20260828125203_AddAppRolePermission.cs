...
{
    /// <inheritdoc />
    public partial class AddAppRolePermission : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppRolePermissions_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                    ...
                    table.ForeignKey(
                        name: "FK_AppRolePermissions_AspNetUsers_ModifiedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppRolePermissions_CreatedBy",
                table: "AppRolePermissions",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_AppRolePermissions_ModifiedBy",
                table: "AppRolePermissions",
                column: "ModifiedBy");
